...
const translations = {
	'pt-BR': {
		...
		'alert.produto_atualizado': 'Produto atualizado com sucesso!',
		'alert.erro_atualizar_produto': 'Erro ao atualizar produto',
		'alert.acesso_negado_deletar': 'Acesso negado. Apenas administradores podem excluir produtos.',
		'alert.acesso_negado_adicionar': 'Acesso negado. Apenas administradores podem adicionar produtos.',
		'alert.todos_campos_obrigatorios': 'Preencha todos os campos obrigatórios',
		'alert.imagem_grande_demais': 'Imagem muito grande. Máximo 10MB.',
		'alert.formato_nao_suportado': 'Formato de imagem não suportado. Use JPEG, PNG, GIF ou WebP',
		'alert.erro_processar_imagem': 'Erro ao processar imagem',
		'alert.horario_obrigatorio': 'Selecione um horário de entrega.',
		'alert.limite_tentativas': 'Você excedeu o limite de tentativas. Será direcionado(a) para o registro.',
		'alert.senha_padrão_reset': 'Senha resetada para "123456" com sucesso!',
		'alert.erro_resetar_senha': 'Erro ao resetar senha: ',
		'alert.usuario_criado_sucesso': 'Usuário criado com sucesso!',
		'alert.erro_criar_usuario': 'Erro ao criar usuário: ',
		'alert.selecione_data_feriado': 'Selecione uma data primeiro',
		'alert.nenhum_horario_selecionado': 'Selecione pelo menos um horário para cada tipo de dia',
		'alert.config_horarios_salva': 'Configuração de horários salva com sucesso',

		'produtos.desc_pao_mel': 'Delicioso bolo com cobertura de calda de chocolate',
		'produtos.desc_bolo_cenoura': 'Bolo de cenoura macio com calda de chocolate derretido',
		'produtos.desc_torta_limao': 'Torta cremosa com sabor intenso de limão',
		'produtos.desc_brownie': 'Brownie fudge rico e decadente',
		'produtos.desc_cupcake': 'Cupcakes decorados com diferentes sabores',
		'produtos.desc_bolo_chocolate': 'Bolo de chocolate intenso e macio',
		'produtos.desc_torta_morango': 'Torta doce com morangos frescos',
		'produtos.desc_bolo_baunilha': 'Bolo clássico e delicado de baunilha',
		'produtos.desc_bolo_abacaxi': 'Bolo tropical com gosto refrescante de abacaxi',
		'produtos.desc_bolo_coco': 'Bolo macio com sabor tropical de coco',
		'produtos.desc_doce_leite': 'Doce de leite artesanal cremoso',
		'produtos.desc_pao_acucar': 'Pão de açúcar crocante por fora, macio por dentro',
		'produtos.desc_bolo_cafe': 'Bolo aromático com sabor forte de café',
		'produtos.desc_bolo_laranja': 'Bolo refrescante com sabor cítrico de laranja',
		'produtos.desc_bolo_uva': 'Bolo suave com toque de uva',
		'produtos.desc_bolo_banana': 'Bolo macio e úmido de banana'
	},
	'en-US': {
		...
		'alert.produto_atualizado': 'Product updated successfully!',
		'alert.erro_atualizar_produto': 'Error updating product',
		'alert.acesso_negado_deletar': 'Access denied. Only administrators can delete products.',
		'alert.acesso_negado_adicionar': 'Access denied. Only administrators can add products.',
		'alert.todos_campos_obrigatorios': 'Please fill in all required fields',
		'alert.imagem_grande_demais': 'Image is too large. Maximum 10MB.',
		'alert.formato_nao_suportado': 'Unsupported image format. Use JPEG, PNG, GIF or WebP.',
		'alert.erro_processar_imagem': 'Error processing image',
		'alert.horario_obrigatorio': 'Select a delivery time.',
		'alert.limite_tentativas': 'You have exceeded the attempt limit. You will be directed to registration.',
		'alert.senha_padrão_reset': 'Password reset to "123456" successfully!',
		'alert.erro_resetar_senha': 'Error resetting password: ',
		'alert.usuario_criado_sucesso': 'User created successfully!',
		'alert.erro_criar_usuario': 'Error creating user: ',
		'alert.selecione_data_feriado': 'Please select a date first',
		'alert.nenhum_horario_selecionado': 'Select at least one time for each day type',
		'alert.config_horarios_salva': 'Delivery times configuration saved successfully',

		'produtos.desc_pao_mel': 'Delicious honey cake with chocolate topping',
		'produtos.desc_bolo_cenoura': 'Soft carrot cake with melted chocolate glaze',
		'produtos.desc_torta_limao': 'Creamy lemon pie with intense citrus flavor',
		'produtos.desc_brownie': 'Rich and decadent fudge brownie',
		'produtos.desc_cupcake': 'Decorated cupcakes with various flavors',
		'produtos.desc_bolo_chocolate': 'Intense and soft chocolate cake',
		'produtos.desc_torta_morango': 'Sweet pie with fresh strawberries',
		'produtos.desc_bolo_baunilha': 'Classic and delicate vanilla cake',
		'produtos.desc_bolo_abacaxi': 'Tropical cake with refreshing pineapple flavor',
		'produtos.desc_bolo_coco': 'Soft cake with tropical coconut flavor',
		'produtos.desc_doce_leite': 'Creamy artisanal dulce de leche',
		'produtos.desc_pao_acucar': 'Crispy sugar bread, soft inside',
		'produtos.desc_bolo_cafe': 'Aromatic cake with strong coffee flavor',
		'produtos.desc_bolo_laranja': 'Refreshing cake with orange citrus flavor',
		'produtos.desc_bolo_uva': 'Soft cake with a touch of grape',
		'produtos.desc_bolo_banana': 'Soft and moist banana cake'
	}
};
